...
import me.bossm0n5t3r.advanced.chapter08.Exercise03XmlSerializer.LowerCaseName
import me.bossm0n5t3r.advanced.chapter08.Exercise03XmlSerializer.SerializationIgnore
import me.bossm0n5t3r.advanced.chapter08.Exercise03XmlSerializer.SerializationIgnoreNulls
import me.bossm0n5t3r.advanced.chapter08.Exercise03XmlSerializer.SerializationName
import me.bossm0n5t3r.advanced.chapter08.Exercise03XmlSerializer.SerializationNameMapper
import me.bossm0n5t3r.advanced.chapter08.Exercise03XmlSerializer.SnakeCaseName
import me.bossm0n5t3r.advanced.chapter08.Exercise03XmlSerializer.UpperSnakeCaseName
import me.bossm0n5t3r.advanced.chapter08.Exercise03XmlSerializer.serializeToXml
import kotlin.test.Test
import kotlin.test.assertEquals

class Exercise03XmlSerializerTest {
    @Test
    fun `sample data class`() {
    ...
    fun librarySerializationWithUpperSnakeCaseName() {
        ...
        assertEquals(
            "<LIBRARY><CATALOG><BOOK><AUTHOR>J. R. R. Tolkien</AUTHOR><ISBN>978-0-261-10235-4</ISBN><YEAR>1937</YEAR><TITLE>The Hobbit</TITLE></BOOK><BOOK><AUTHOR>Andrzej Sapkowski</AUTHOR><ISBN>978-0-575-09404-2</ISBN><YEAR>1993</YEAR><TITLE>The Witcher</TITLE></BOOK><BOOK><AUTHOR>Nassim Nicholas Taleb</AUTHOR><YEAR>2012</YEAR><TITLE>Antifragile</TITLE></BOOK></CATALOG></LIBRARY>",
    ...
    fun `should ignore nulls if annotation used`() {
        ...
        val creatureIgnoring =
            CreatureIgnoringNulls(
                name = "Cockatrice",
                attack = null,
                defence = 4,
                extraDetails = null,
